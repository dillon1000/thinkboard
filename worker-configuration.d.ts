/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=infra/cloudflare/wrangler.jsonc` (hash: 573113a80bd7ec39f4cb57ee81f2bb7c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODEL" | "LOCK_IN_MODEL" | "AI_GATEWAY_ID" | "EMBEDDING_MODEL" | "OCR_MODEL" | "PDF_DAILY_PAGE_QUOTA" | "PDF_STORED_BYTES_QUOTA" | "BETTER_AUTH_URL" | "OAUTH_PROVIDER_ID" | "OAUTH_PROVIDER_NAME" | "BETTER_AUTH_SECRET" | "OAUTH_DISCOVERY_URL" | "OAUTH_CLIENT_ID" | "OAUTH_CLIENT_SECRET" | "TLDRAW_LICENSE_KEY" | "SPOTIFY_CLIENT_ID" | "SPOTIFY_CLIENT_SECRET">> {}
}
declare module "*.sql" {
	const value: string;
