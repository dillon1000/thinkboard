/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=infra/cloudflare/wrangler.jsonc` (hash: 2107fe590cd0774d4cde6fbeec38c703)
// Runtime types generated with workerd@1.20260722.1 2026-07-19 nodejs_compat
interface __BaseEnv_Env {
	INTEGRATIONS: KVNamespace;
	TLDRAW_BUCKET: R2Bucket;
	DB: D1Database;
	DOCUMENT_VECTORS: VectorizeIndex;
	DOCUMENT_PIPELINE: Queue;
	AI: Ai;
	ASSETS: Fetcher;
	AI_MODEL: "openai/gpt-5.6-luna";
	LOCK_IN_MODEL: "@cf/meta/llama-4-scout-17b-16e-instruct";
	FLASHCARD_GRADING_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast";
	CONVERSATION_TITLE_MODEL: "@cf/meta/llama-4-scout-17b-16e-instruct";
	AI_GATEWAY_ID: "default";
	EMBEDDING_MODEL: "@cf/baai/bge-large-en-v1.5";
	OCR_MODEL: "@cf/meta/llama-4-scout-17b-16e-instruct";
	PDF_DAILY_PAGE_QUOTA: "1000";
	PDF_STORED_BYTES_QUOTA: "2147483648";
	SANDBOX_TRANSPORT: "rpc";
	POSTHOG_HOST: "https://us.i.posthog.com";
	BETTER_AUTH_URL: "https://ts.dillonr.ing";
	OAUTH_PROVIDER_ID: "campus-sso";
	OAUTH_PROVIDER_NAME: "Passport";
	...
	StudyAgent: DurableObjectNamespace<import("./src/worker/index").StudyAgent>;
	Sandbox: DurableObjectNamespace<import("./src/worker/index").Sandbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "BoardRoom" | "StudyAgent" | "Sandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODEL" | "LOCK_IN_MODEL" | "FLASHCARD_GRADING_MODEL" | "CONVERSATION_TITLE_MODEL" | "AI_GATEWAY_ID" | "EMBEDDING_MODEL" | "OCR_MODEL" | "PDF_DAILY_PAGE_QUOTA" | "PDF_STORED_BYTES_QUOTA" | "SANDBOX_TRANSPORT" | "POSTHOG_HOST" | "BETTER_AUTH_URL" | "OAUTH_PROVIDER_ID" | "OAUTH_PROVIDER_NAME" | "BETTER_AUTH_SECRET" | "OAUTH_DISCOVERY_URL" | "OAUTH_CLIENT_ID" | "OAUTH_CLIENT_SECRET" | "TLDRAW_LICENSE_KEY" | "POSTHOG_PROJECT_TOKEN" | "EXA_API_KEY" | "SPOTIFY_CLIENT_ID" | "SPOTIFY_CLIENT_SECRET" | "OPENROUTER_API_KEY">> {}
}
declare module "*.sql" {
	const value: string;
